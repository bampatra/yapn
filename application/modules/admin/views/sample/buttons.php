...
<head>
  ...
  <title>SB Admin 2 - Buttons</title>
    ...
    <link href="<?php echo base_url('assets/css/startbootstrap/sb-admin-2.min.css');?>" rel="stylesheet">
...
<body id="page-top">
  ...
  <!--<?php echo base_url('vendor/jquery-easing/jquery.easing.min.js');?>-->
  ...
  <script src="<?php echo base_url('assets/js/startbootstrap/demo/chart-area-demo.js');?>"></script>
  <script src="<?php echo base_url('assets/js/startbootstrap/demo/chart-pie-demo.js');?>"></script>
