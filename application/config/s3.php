...
$config['access_key'] = 'AKIAI3V2UGDXC7CYBI3A';
...
$config['secret_key'] = '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';
...
$config['s3_url'] = 'https://pira.s3.ap-southeast-1.amazonaws.com/';
